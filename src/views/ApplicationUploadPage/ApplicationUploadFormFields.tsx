...
},
{
    ...
    text_type:"text",
    placeholder: "Rajesh",
    errorMessage: "User name should be 3-16 characters and shouldn't include any special character and Numbers!",
    label: "Your Name",
    minlen:3,
    maxlen:16,
...
},
{
    ...
    text_type:"text",
    placeholder: "ABC,BCA",
    errorMessage: "Workshop name should be 1-16 characters and shouldn't include any special character and Numbers!",
